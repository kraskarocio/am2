...
Sea $f:D \subset R^n \to R^m$. Se dice que $f$ es \textbf{continua} en un punto $X_0 \in D$ si:
\begin{itemize}
...
Sea $f:D \subset R^n \to R^m$ y $g:E \subset R^m \to R^p$ y supongamos que
$f(D) \subset E$. Si $f$ es continua en $X_0 \in D$ y $g$ es continua en
$f(X_0) \in E$, entonces la función compuesta $g \circ f:D \to R^p$, definida por 
...
\begin{itemize}
    \item Sea $f:R^n \to R^m$ una función continua y $C \subset R^n$ un conjunto conexo.
    Entonces el conjunto $f(C) \subset R^m$ es conexo.
    \item Sea $f:R^n \to R^m$ una función continua y $C \subset R^n$ un conjunto compacto.
    Entonces el conjunto $f(C) \subset R^m$ es compacto.
\end{itemize}

\begin{nota}[colback=green!5,colframe=green!80, title=Definición importante]
Sea $\vec{g}: I \subset R \to R^n$. Entonces si 
$
\begin{cases}
...
\begin{nota}[colback=blue!5,colframe=blue!60, title=Definiciones]
Dada una curva $C \subset R^m$ de ecuación $\vec{X}=\vec{g}(t)$ definimos:
\begin{itemize}
