...
$f = (f_1, f_2, \ldots, f_m): D \subset \mathbb{R}^n \to \mathbb{R}^m$ con $m > 1$. Donde cada componente $f_i$ 
con $i = 1, \ldots, m$ es una función escalar definida en $D$.

$$
f_i : D \subset \mathbb{R}^n \to \mathbb{R} \quad \text{con } i = 1, \ldots, m
$$

\subsection{Representaciones geométricas de una función escalar}

Sea
$f : D \subset \mathbb{R}^n \to \mathbb{R}$, se denomina gráfica de $f$ al conjunto
$G_f \subset \mathbb{R}^{n+1}$
definido por:

$$
G_f \doteq \{   
    (x_1, \ldots, x_n, u) \in \mathbb{R}^{n+1} \mid (x_1, \ldots, x_n) \in D, u = f(x_1, \ldots, x_n)
\}
$$

\subsubsection{Conjunto de nivel}
Sea $f : D \subset \mathbb{R}^n \to \mathbb{R}$ el conjunto de nivel $k$ de $f$ es el conjunto
$N_k \subset \mathbb{R}^n$ definido por:
$$
N_k \doteq \{   (x_1, \ldots, x_n) \in \mathbb{R}^n \mid
...
$\vec{f} : D \subset \mathbb{R}^n \to \mathbb{R}^m$ con $m > 1$,
el conjunto imagen es
$$Im(\vec{f}) = \{    \vec{X} \in \mathbb{R}^m \mid \vec{X} = \vec{f}(\vec{U}), \vec{U} \in D  \} $$
...
\begin{figure}[H] 
    ...
    \caption{Dada $\vec{f}:[0,1] \subset \mathbb{R} \to \mathbb{R}^2 / \vec{f}(t) = (t, t^2)$, represente el correspondiente conjunto imagen.}
    \label{fig:2.3ej}
\end{figure}