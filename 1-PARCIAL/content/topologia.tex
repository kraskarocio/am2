...
\subsection*{Puntos}
Siendo $S \subset \mathbb{R}^n$ y $A \in \mathbb{R}^n$:
\begin{itemize}
    ...
    \item Un punto $A \in S \subset \mathbb{R}^n$ es \textbf{punto aislado} de $S$ cuando existe algún 
...
\begin{itemize}
    \item $S \subset \mathbb{R}^n$ es un \textbf{conjunto abierto} cuando todos sus puntos son interiores.
    \item $S \subset \mathbb{R}^n$ es un \textbf{conjunto cerrado} cuando contiene a todos sus puntos de acumulación.
    \item $S \subset \mathbb{R}^n$ es un \textbf{conjunto acotado} cuando se lo puede incluir en una esfera abierta con centro en el origen y
radio finito.
    \item $S \subset \mathbb{R}^n$ es un \textbf{conjunto compacto} cuando es cerrado y acotado.
    \item $S \subset \mathbb{R}^n$ es un \textbf{conjunto conexo} cuando dados dos puntos cualesquiera $A,B \in S$, “es posible ir
